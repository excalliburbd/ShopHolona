...
export default class ReactZoomify extends React.Component{
  ...
  componentWillUnmount(){
    ...
    let img=this.refs.img.removeEventListener('load', () => {
  ...
  render(){
    ...
    return  <div className="image-zoom" style={{position:'static'}}>
      ...
      <div className="image-zoom--selection"
        style={{
          position:'absolute',
          width:`${s}px`,
          height:`${s}px`,
      ...
      <div className="image-zoom--zoomed-img"
        style={{
          width:`${S}px`,
          height:`${S}px`,
          background:'#ccc',
