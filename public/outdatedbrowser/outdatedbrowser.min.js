...
var outdatedBrowser = function(t) {
  ...
  function r() {
    ...
    (s.style.backgroundColor = bkgColor), (s.style.color = txtColor), (s.children[0].style.color = txtColor), (s.children[1].style.color = txtColor), (o.style.color = txtColor), o
      .style.borderColor &&
      (o.style.borderColor = txtColor), (t.style.color = txtColor), (t.onmousedown = function() {
  ...
  function n(t) {
    ...
    return 4 == t.readyState &&
      (
        (o.innerHTML = 200 == t.status || 304 == t.status ? t.responseText : d),
        r()
      ), !1;
  }
